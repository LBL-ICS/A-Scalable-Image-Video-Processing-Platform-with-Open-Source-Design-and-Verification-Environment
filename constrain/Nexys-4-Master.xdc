...
set_property PACKAGE_PIN U9 [get_ports {reg_conf_rst}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reg_conf_rst}]
...
set_property PACKAGE_PIN T8 [get_ports reg_conf_finish]					
	set_property IOSTANDARD LVCMOS33 [get_ports reg_conf_finish]
...
##Pmod Header ov7670_data
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = ov7670_data1
set_property PACKAGE_PIN B13 [get_ports {cap_d[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[7]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = ov7670_data2
set_property PACKAGE_PIN F14 [get_ports {cap_d[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[5]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = ov7670_data3
set_property PACKAGE_PIN D17 [get_ports {cap_d[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[3]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = ov7670_data4
set_property PACKAGE_PIN E17 [get_ports {cap_d[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[1]}]
##Bank = 15, Pin name = IO_0_15,								Sch name = ov7670_data7
set_property PACKAGE_PIN G13 [get_ports {cap_d[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[6]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = ov7670_data8
set_property PACKAGE_PIN C17 [get_ports {cap_d[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[4]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = ov7670_data9
set_property PACKAGE_PIN D18 [get_ports {cap_d[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[2]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = ov7670_data10
set_property PACKAGE_PIN E18 [get_ports {cap_d[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cap_d[0]}]



##Pmod Header ov7670
##Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,				Sch name = ov76701
set_property PACKAGE_PIN G14     [get_ports sioc]					
set_property IOSTANDARD LVCMOS33 [get_ports sioc]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = ov76702
set_property PACKAGE_PIN P15     [get_ports cap_vsync]					
set_property IOSTANDARD LVCMOS33 [get_ports cap_vsync]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = ov76703
set_property PACKAGE_PIN V11 [get_ports cap_pclk]					
	set_property IOSTANDARD LVCMOS33 [get_ports cap_pclk]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = ov76704
set_property PACKAGE_PIN V15 [get_ports ov7670_rst]					
	set_property IOSTANDARD LVCMOS33 [get_ports ov7670_rst]
##Bank = 15, Pin name = IO_25_15,							Sch name = ov76707
set_property PACKAGE_PIN K16 [get_ports siod]					
	set_property IOSTANDARD LVCMOS33 [get_ports siod]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = ov76708
set_property PACKAGE_PIN R16 [get_ports cap_href]					
	set_property IOSTANDARD LVCMOS33 [get_ports cap_href]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = ov76709
set_property PACKAGE_PIN T9 [get_ports ov7670_xclk]					
	set_property IOSTANDARD LVCMOS33 [get_ports ov7670_xclk]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = ov767010 
